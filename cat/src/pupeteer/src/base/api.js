...
const api = {
    ...
    saveZhiHu:  _path.localhost + 'zhiHu/save',
    newHouse:  _path.localhost + 'house/saveNewHouse',
};
...
const saveZhiHu = async function (title, content, hot, ranking, image) {
    const param = {title, content, hot, ranking, image};
    await rp.post({uri: api.saveZhiHu, qs: param, json: true});
};

const newHouse = async function (title, province, district, price, detailUrl, firstImage, tags, address, norms) {
    const param = {title, province, district, price, detailUrl, firstImage, tags, address, norms};
    await rp.post({uri: api.newHouse, qs: param, json: true});
};
