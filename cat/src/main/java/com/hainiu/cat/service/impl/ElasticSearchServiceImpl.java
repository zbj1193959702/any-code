...
import com.hainiu.cat.dao.mapper.ElasticSearchMapper;
import com.hainiu.cat.dao.mapper.LvmamaScenicSpotMapper;
//import com.hainiu.cat.dao.mapper.ScenicSpotEsMapper;
import com.hainiu.cat.dao.model.EsScenicSpot;
...
//    }
    ...
    public PageResult<LvmamaScenicSpotDTO> queryScenicSpot(String title, Integer pageStart, Integer pageSize) throws IOException {
        ...
        result.setTotalRecordCount(Math.toIntExact(response.getHits().getTotalHits()));
